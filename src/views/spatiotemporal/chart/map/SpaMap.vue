  ...
  export default {
    ...
    methods: {
      initAqiMap(index,index_name) {
        ...
        let option;
        axios.get('/2013010100.json',{}).then(res => {
          // console.log(res);
          ...
          option = {
            baseOption: {
              ...
              visualMap: {
                min: 0,
                max: getMaxValue(this.allData, index),
                //分段数量
                splitNumber: 5,
                inRange: {
                  color: ['#F7956C', '#ED93D3', '#4B6F55', '#1C346C','#EA0A34']
                },
                textStyle: {
                  color: '#fff',
                  fontWeight: 'bolder'
      ...
      aqiClick() {
        this.baseTitle = 'AQI'
        this.topTitle = 'AQI - TOP15'
        this.initAqiMap(0,'aqi')
      },
      pm25Click() {
        this.baseTitle = 'PM2.5'
        this.topTitle = 'PM2.5 - TOP15'
        this.initAqiMap(1,'PM2.5')
      },
      pm10Click() {
        this.baseTitle = 'PM10'
        this.topTitle = 'PM10 - TOP15'
        this.initAqiMap(2,'PM10')
      },
      so2Click() {
        this.baseTitle = 'SO2'
        this.topTitle = 'SO2 - TOP15'
        this.initAqiMap(3,'SO2')
      },
      no2Click() {
        this.baseTitle = 'NO2'
        this.topTitle = 'NO2 - TOP15'
        this.initAqiMap(4,'NO2')
      },
      coClick() {
        this.baseTitle = 'CO'
        this.topTitle = 'CO - TOP15'
        this.initAqiMap(5,'CO')
      },
      o3Click() {
        this.baseTitle = 'O3'
        this.topTitle = 'O3 - TOP15'
